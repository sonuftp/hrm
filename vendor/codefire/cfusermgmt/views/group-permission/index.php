...
<div class="radius_box">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            unset($mode_data_final['debug']);
            unset($mode_data_final['gii']);
            echo Html::dropDownList('mode_name', $selection = null, $mode_data_final, $options = ['style' => 'padding: 5px; width: 200px; margin-top: 9px;', 'id' => 'allControllerMode']);
            ?>
        </div>
    </div>
    <br><br>
