...
<div class="modal-header">      
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
            <?php echo $form->field($model, 'name')->textInput(['placeholder' => ROLEANDPERMISSION_SAVE_NAME])->label(false); ?>
		</div>
	</div>
    <div class="form-group">
	...
	<div class="panel-footer  margin_top10">
		<div class="row">
			...
			<?php echo Html::submitButton('Submit', ['class' => 'btn btn-primary']); ?></div>
		</div>
	</div>
  <?php ActiveForm::end(); ?>
</div>
